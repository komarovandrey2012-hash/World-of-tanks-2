...
#     player = tanks_collection.get_player()
#     if hasattr(player, '_hp_indicator'):
#         # print(f"Индикатор игрока существует: {player._hp_indicator}")
#         # print(f"ID индикатора: {player._hp_indicator._image_id}")
#         # Принудительно обновим позицию
#         player._hp_indicator.update()
#
# # Добавь кнопку для отладки
# debug_btn = Button(w, text="Проверить HP", command=debug_hp)
# debug_btn.pack()
